package cn.yiyang.system.websocket.service;


import cn.hutool.core.date.DateUtil;
import cn.hutool.core.lang.Dict;
import cn.yiyang.system.websocket.entity.Client;
...
public class SocketService {
    ...
    public synchronized static void timeMsgToall() {
        logger.info("发送消息中...");
        socketServers.stream().filter(cli -> cli.getUserName() != SYS_USERNAME)
                .forEach(client -> {
                    Dict set = Dict.create().set("name", "王一扬");
